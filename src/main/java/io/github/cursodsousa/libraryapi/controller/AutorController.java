...
import io.github.cursodsousa.libraryapi.securitiy.SecurityService;
...
public class AutorController implements GenericController {
    ...
    public ResponseEntity<Void> salvar(@RequestBody @Valid AutorDTO dto) {
        ...
        //URL: http://localhost:8080/autores/d37210d8-600a-4269-beee-9d9903e5b8b8
        URI location = gererHeaderLocation(autor.getId());
