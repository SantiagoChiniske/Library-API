...
public class LivroController implements GenericController {
    ...
    public ResponseEntity<Void> salvar(@RequestBody @Valid CadastroLivroDTO dto) {
        ...
        //Transforma a entidade DTO em uma entidade
        Livro livro = mapper.toEntity(dto);

        //Salva no banco
        service.salvar(livro);

        //Constroi a URL para acessar o item
        var url = gererHeaderLocation(livro.getId());
        //Retorna a url
    ...
    public ResponseEntity<Page<ResultadoPesquisaLivroDTO>> pesquisa(
        ...
        Page<Livro> paginaResultado = service.pesquisa(
                isbn, titulo, nomeAutor, genero, anoPublicao,pagina,tamanhoPagina);
